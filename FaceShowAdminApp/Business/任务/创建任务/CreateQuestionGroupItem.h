...
@property (nonatomic, strong) NSArray<CreateQuestionGroupItem_Question_VoteInfo_VoteItem, Optional> *voteItems;
@end
...
@property (nonatomic, copy) NSString<Optional> *title;
@property (nonatomic, copy) NSString<Optional> *desc;
@property (nonatomic, strong) NSArray<CreateQuestionGroupItem_Question, Optional> *questions;
@end
