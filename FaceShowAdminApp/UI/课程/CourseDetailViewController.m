...
- (void)setupUI {
    ...
    self.headerImageView.image = [UIImage imageNamed:@"bannner"];
    ...
    [courseInfoButton setTitleColor:[UIColor colorWithHexString:@"0068bd"] forState:UIControlStateNormal];
    [courseInfoButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    [courseInfoButton setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexString:@"0068bd"]] forState:UIControlStateHighlighted];
    ...
    courseInfoButton.layer.borderColor = [UIColor colorWithHexString:@"0068bd"].CGColor;
