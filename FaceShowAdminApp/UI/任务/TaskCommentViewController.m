...
@property (nonatomic, strong) GetTaskCommentRequestItem *commentRequestItem;
...
- (void)viewDidLoad {
    ...
    TaskCommentDataFetcher *fetcher = [[TaskCommentDataFetcher alloc]init];
    fetcher.stepId = self.stepId;
    fetcher.lastID = 0;
    WEAK_SELF
    [fetcher setFinishBlock:^(GetTaskCommentRequestItem *item){
        STRONG_SELF
